(function() {
	...
	window.App = new Vue({
		...
		el: '#App',
		data: {
            upline: 'THhKEnmUGX5waDZCwwHQgqhtAnBqU3etAz', // TLcXTxAifGTjZaVdwCJWaX73Q7CNE4r8Sq - Zero address
            contract_address: 'TLcXTxAifGTjZaVdwCJWaX73Q7CNE4r8Sq',
            contract: {
                invested: 0,
                withdraw: 0,
                direct_bonus: 0,
...
{days: 79, percent: 293},
		...
		methods: {
            ...
            getEventsList() {
            	fetch('https://api.shasta.trongrid.io/v1/contracts/TLcXTxAifGTjZaVdwCJWaX73Q7CNE4r8Sq/events?event_name=&only_confirmed=true&order_by=block_timestamp%2Cdesc').then(r => r.json()).then(res => {
            		res.data.forEach(v => {
            			this.events.push({
