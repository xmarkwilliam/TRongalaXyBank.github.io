(function() {
	...
	window.App = new Vue({
		...
		el: '#App',
		data: {
            upline: 'THhKEnmUGX5waDZCwwHQgqhtAnBqU3etAz', // TLHe8XdytRJ8gtqhHMYo82TXCvi6RNaGZs - Zero address
            contract_address: 'TLHe8XdytRJ8gtqhHMYo82TXCvi6RNaGZs',
            contract: {
                invested: 0,
                withdraw: 0,
                direct_bonus: 0,
...
{days: 79, percent: 293},
		...
		methods: {
            ...
            getEventsList() {
            	fetch('https://api.shasta.trongrid.io/v1/contracts/TLHe8XdytRJ8gtqhHMYo82TXCvi6RNaGZs/events?event_name=&only_confirmed=true&order_by=block_timestamp%2Cdesc').then(r => r.json()).then(res => {
            		res.data.forEach(v => {
            			this.events.push({
